export default {
  ...
  'CheckOrder.form.createdTime': '创建时间',
  'CheckOrder.form.status': '状态',
  'CheckOrder.form.status.no_distribute': '未分发',
  'CheckOrder.form.status.distributed': '已分发',
  'CheckOrder.form.status.stocked': '已入分站库',
  'CheckOrder.form.status.0': '未分发',
  'CheckOrder.form.status.1': '已分发',
  'CheckOrder.form.status.2': '已入分站库',
  ...
  'CheckOrder.operation.download': '下载',
