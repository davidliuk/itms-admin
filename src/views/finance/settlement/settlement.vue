    ...
    <a-card class="general-card" :title="$t('menu.finance.settlement')">
      ...
      <a-row style="margin-bottom: 16px">
        <a-col :span="12">
          ...
          <a-space size="large">
            <a-statistic :title="$t('settlement.columns.paymentSum')"
                         :value="9832" show-group-separator />
            <a-statistic :title="$t('settlement.columns.returnPaymentSum')"
                         :value="384" show-group-separator />
          </a-space>
        </a-col>
        <a-col
          :span="12"
...
<script lang="ts" setup>
  ...
  const columns = computed<TableColumnData[]>(() => [
    ...
    {
      title: t('settlement.columns.createdTime'),
