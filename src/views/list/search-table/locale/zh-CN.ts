export default {
  ...
  'searchTable.form.name.placeholder': '请输入会员ID',
  'searchTable.form.receiver_name': '收货人',
  'searchTable.form.logistics': '运输公司',
  'searchTable.form.receiver_name.placeholder': '请输入收货人姓名',
  'searchTable.form.logistics.placeholder': '请输入运输公司',
  'searchTable.form.order_status': '订单状态',
  'searchTable.form.order_status.ALL': '全部',
  'searchTable.form.order_status.UNPAID': '未付款',
  'searchTable.form.order_status.PAID': '已付款',
  'searchTable.form.order_status.DISPATCH': '已调度',
  'searchTable.form.order_status.OUT': '出库中',
  'searchTable.form.order_status.IN': '入库中',
  'searchTable.form.order_status.ASSIGN': '配送中',
  'searchTable.form.order_status.TAKE': '已送达',
  'searchTable.form.order_status.RECEIVE': '已收货',
  'searchTable.form.order_status.REFUND': '已退货',
  'searchTable.form.order_status.CANCEL': '已取消',
  'searchTable.form.payment_time': '支付时间',
  'searchTable.form.take_name': '站点名称',
  'searchTable.form.courier': '配送员',
  'searchTable.form.courier_name': '配送员',
