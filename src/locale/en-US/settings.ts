export default {
  ...
  'settings.alertContent':
    'After the configuration is only temporarily effective, if you want to really affect the skuware, click the "Copy Settings" button below and replace the configuration in settings.json.',
